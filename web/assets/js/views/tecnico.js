...
const TecnicoView = {
    ...
    bindEvents: function() {
        ...
        document.querySelectorAll('input, textarea').forEach(el => {
            el.addEventListener('keydown', () => SoundFx.init() && SoundFx.type());
        });
    ...
    actualizarUI: function() {
        ...
        if (this.state.status === 'libre') {
            ...
            UI.updateBanner(this.state.actividad, '0 min');
            ...
            document.getElementById('tec-banner-estado').innerText = 
                `PAUSA POR: ${this.state.motivo || 'NO ESPECIFICADO'}`;
    ...
    mostrarAlertaPopup: function(asignacion) {
        ...
        if (asignacion.tipo_actividad === CONFIG.TIPOS_ACTIVIDAD.EMERGENCIA) {
            ...
            UI.showPedidoVentas(asignacion.actividad);
        }
    },
